...
def transform_date():
    raw_data_s3_bucket = "s3://redfin-data-project-yml-1/store-raw-data-yml/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-data-project-yml-1/redfin-transform-zone-yml/redfin_data.csv"
    ...
    #let us write the final dataframe into our s3 bucket as a csv file.
    df_redfin.write.mode("overwrite").option("header", "true").csv(transform_data_s3_bucket)
